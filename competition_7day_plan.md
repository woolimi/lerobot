...
- [ ] 바닥에 어두운 단색 시트지 부착
- [ ] 바구니 위치 확정 후 테이프로 고정
- [ ] 붕어빵 5개 배치할 시작 위치 3~5곳 표시
- [ ] Top-down 카메라 장착·각도 조정 (바닥·인형·바구니가 한 화면에)
- [ ] Wrist 카메라 장착·각도 조정 (그립 시 인형이 잘 보이도록)
- [ ] 5개 깔고 1개 담기 방식으로 10개 에피소드 녹화
- [ ] 10개 데이터로 ACT 짧게 학습 → **v0.1-pilot** 저장
- [ ] 로봇이 인형 쪽으로 팔을 뻗는지 확인 (방향성만 확인)
