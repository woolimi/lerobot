...
@dataclass
class VisionConfigPath:
    """
    Path to shared vision config YAML/JSON.
    Record and teleoperate load the actual VisionConfig via lerobot.common.vision_config.load_vision_config.
    """
    config_path: str = ""
...
class DatasetConfig:
    ...
    # When True, load IBR images (observation.images.<cam>_ibr) as the main camera when present.
    use_ibr_images: bool = False
